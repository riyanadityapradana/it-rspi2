    ...
    <div class="card">
      ...
      <div class="card-body" style="max-height:400px;overflow-y:auto;">
        <table class="table table-bordered table-striped">
          ...
          <tbody>
            <?php
            $sqlPerbaikan = "SELECT p.*, b.nama_barang FROM tb_perbaikan_barang p JOIN tb_barang b ON p.barang_id = b.barang_id WHERE p.tindakan_perbaikan = 'Service luar' AND p.status = 'proses' ORDER BY p.tanggal_lapor DESC LIMIT 10";
